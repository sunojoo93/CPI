...
enum ENUM_PARA_LCP_CONCEALMENT_COMMON
{
	E_PARA_LCP_CONCEALMENT_COMMON_BLUR_LOOP = 0,	// Blur 5x5 반복
	E_PARA_LCP_CONCEALMENT_COMMON_BLUR_LOOP_SIZE,	// Blur 5x5 반복
	E_PARA_LCP_CONCEALMENT_COMMON_SEG_X,	// 분할 이진화 영역 X
	E_PARA_LCP_CONCEALMENT_COMMON_SEG_Y,	// 분할 이진화 영역 Y
	E_PARA_LCP_CONCEALMENT_COMMON_MIN_THRESHOLD,	// 최소 이진화 값 ( 어두운 밝기일때 사용 )
	E_PARA_LCP_CONCEALMENT_COMMON_MEDIAN,	// 큰 불량인 경우, 영역 평균값이 주변대비 다름
	E_PARA_LCP_CONCEALMENT_COMMON_POW_USE,
	E_PARA_LCP_CONCEALMENT_COMMON_POW_VALUE,	// Pow
	E_PARA_LCP_CONCEALMENT_COMMON_ACTIVE_TEXT,	// 텍스트 표시
	E_PARA_LCP_CONCEALMENT_COMMON_ACTIVE_DARK_RATIO,	// Dark 불량 주변 밝기 대비
	E_PARA_LCP_CONCEALMENT_COMMON_ACTIVE_BRIGHT_RATIO,	// Bright 불량 주변 밝기 대비
	E_PARA_LCP_CONCEALMENT_COMMON_EDGE_TEXT,	// 텍스트 표시
	E_PARA_LCP_CONCEALMENT_COMMON_EDGE_AREA,	// 외곽으로부터 범위 설정
	E_PARA_LCP_CONCEALMENT_COMMON_EDGE_DARK_RATIO,	// Dark 불량 주변 밝기 대비
	E_PARA_LCP_CONCEALMENT_COMMON_EDGE_BRIGHT_RATIO,	// Bright 불량 주변 밝기 대비

	E_PARA_LCP_CONCEALMENT_COMMON_TOTAL_COUNT
};

enum ENUM_PARA_LCP_CONCEALMENT_AREA
{
	//Mask
	E_PARA_LCP_CONCEALMENT_AREA_MASK_TEXT = E_PARA_LCP_CONCEALMENT_COMMON_TOTAL_COUNT,
	E_PARA_LCP_CONCEALMENT_AREA_MASK_SIZE_DOWN,

	//Firts Judge
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_TEXT,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_AXIO_RATIO,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_AREA_RATIO,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_AREA_MIN,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_AREA_MAX,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_SPEC1_TEXT,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_SPEC1_USE,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_SPEC1_AREA_MIN,
	E_PARA_LCP_CONCEALMENT_AREA_FIRST_JUDGE_SPEC1_AXIO_RATIO,

	E_PARA_LCP_CONCEALMENT_AREA_TOTAL_COUNT								// Total
};

// Morphology - Operation
enum ENUM_CONCEALMENT_MORP
{
	E_CONCEALMENT_MORP_ERODE = 0,
	E_CONCEALMENT_MORP_DILATE,
	E_CONCEALMENT_MORP_OPEN,
	E_CONCEALMENT_MORP_CLOSE
};

class CInspectConcealment
{
public:
	CInspectConcealment();
	virtual ~CInspectConcealment();
	...
	// Main 검사 알고리즘
	long		DoFindConcealmentDefect(cv::Mat matSrcBuffer, cv::Mat& matBKBuffer, cv::Mat& matDarkBuffer, cv::Mat& matBrightBuffer, cv::Mat matMask_Active,
	...
	long		LCP_AREA_Concealment(cv::Mat& matSrcImage, cv::Mat* matDstImage, cv::Mat matMask_Active, CRect rectROI, cv::Rect rcAlignCellROI, double* dPara, int* nCommonPara, CString strAlgPath, CString strBubblePath, CString strBubblePath_Menual, ENUM_INSPECT_MODE eInspMode, STRU_DEFECT_ITEM* EngineerDefectJudgment);
	...
	int First_blob_Concealment(cv::Mat Srcimg, cv::Mat DstImg, cv::Mat matLabels, cv::Mat stats, cv::Mat centroids, cv::Rect rectTemp_Dust, double* dPara);
};
