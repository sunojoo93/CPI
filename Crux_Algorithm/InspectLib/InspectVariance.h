...
{
	E_PARA_LCP_VARIANCE_COMMON_BLUR_LOOP = 0,	// Blur 5x5 반복
	E_PARA_LCP_VARIANCE_COMMON_BLUR_LOOP_SIZE,	// Blur 5x5 반복
	E_PARA_LCP_VARIANCE_COMMON_SEG_X,	// 분할 이진화 영역 X
	E_PARA_LCP_VARIANCE_COMMON_SEG_Y,	// 분할 이진화 영역 Y
	E_PARA_LCP_VARIANCE_COMMON_MIN_THRESHOLD,	// 최소 이진화 값 ( 어두운 밝기일때 사용 )
	E_PARA_LCP_VARIANCE_COMMON_MEDIAN,	// 큰 불량인 경우, 영역 평균값이 주변대비 다름
	E_PARA_LCP_VARIANCE_COMMON_POW_USE,
	E_PARA_LCP_VARIANCE_COMMON_POW_VALUE,	// Pow
	E_PARA_LCP_VARIANCE_COMMON_ACTIVE_TEXT,	// 텍스트 표시
	E_PARA_LCP_VARIANCE_COMMON_ACTIVE_DARK_RATIO,	// Dark 불량 주변 밝기 대비
	E_PARA_LCP_VARIANCE_COMMON_ACTIVE_BRIGHT_RATIO,	// Bright 불량 주변 밝기 대비
	E_PARA_LCP_VARIANCE_COMMON_EDGE_TEXT,	// 텍스트 표시
	E_PARA_LCP_VARIANCE_COMMON_EDGE_AREA,	// 외곽으로부터 범위 설정
	E_PARA_LCP_VARIANCE_COMMON_EDGE_DARK_RATIO,	// Dark 불량 주변 밝기 대비
	E_PARA_LCP_VARIANCE_COMMON_EDGE_BRIGHT_RATIO,	// Bright 불량 주변 밝기 대비
