...
TaskInterfacer::TaskInterfacer(int nTaskNo, int nServerPort, TSTRING szServerIP,
	CString szLogFilePath,			///< 로그 파일 경로
...
int TaskInterfacer::Start()
{
	...
	CInterServerInterface::m_fnPrintLog( LOG_LEVEL_ALWAYS, DEFAULT_LOG_SIZE,  _T("Start Algorithm Task !!\n"));
...
int	 TaskInterfacer::m_fnPrintLog(const wchar_t* pszLogData, ...)		// bSendUI : UI Log 송부 기능 사용 여부
{
