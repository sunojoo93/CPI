#if !defined(AFX_PROTOCOLTrivisionLight_H__4BFD59CF_5181_475A_9AB1_504A19CC2BF9__INCLUDED_)
#define AFX_PROTOCOLTrivisionLight_H__4BFD59CF_5181_475A_9AB1_504A19CC2BF9__INCLUDED_
...
#pragma once
#endif // _MSC_VER > 1000
#define PROTOCOL_TrivisionLight_WAIT			20
#define PROTOCOL_TrivisionLight_LENGTH		512
...
struct LIGHT_TrivisionLight_STATUS {
	//int		nChannelCount;
	//int		nCtrID;
...
class TrivisionLightController  
{
public:
	TrivisionLightController();
	virtual ~TrivisionLightController();

	// Module Set/Get
	void SetOnOff(LIGHT_TrivisionLight_STATUS stLightInfo);
	void GetOnOffAll();
	
	// Brightness Set/Get
	void SetBrightness(LIGHT_TrivisionLight_STATUS stLightInfo);
	...
	// 프로토콜 구조체 생성
	LIGHT_TrivisionLight_STATUS m_stLightStatus;

	HWND	m_hWnd;
	void	*m_pCommTrivisionLight;
