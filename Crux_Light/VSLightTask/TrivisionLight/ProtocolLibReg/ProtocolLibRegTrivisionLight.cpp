// ProtocolLibRegTrivisionLight.cpp : Defines the initialization routines for the DLL.
//
...
#include "ProtocolLibRegTrivisionLight.h"
...
/////////////////////////////////////////////////////////////////////////////
// CProtocolLibRegTrivisionLightApp
...
int OpenPortEx(int port, UINT controlCnt, int nBaud, UINT CtrlChannelCnt[], HWND wnd)
{
	...
	g_ModuleInfo[i].moduleType	= nTotalChCnt;		// 모듈 타입 정의(한 컨트롤러당 제어 가능한 최대 채널 개수)
	g_ModuleInfo[i].port		= port;
	g_ModuleInfo[i].nBaudRate	= nBaud;
