...
class CTrivisionLight : public LightInterface //: public CSerialPort 
{
public:
	CTrivisionLight();	// 표준 생성자입니다.
	virtual ~CTrivisionLight();
...
private:
	...
	CString			GetControllerName()											{	return _T("TrivisionLight Light");	}
