#if !defined(AFX_PROTOCOLSUNIN_H__4BFD59CF_5181_475A_9AB1_504A19CC2BF9__INCLUDED_)
#define AFX_PROTOCOLSUNIN_H__4BFD59CF_5181_475A_9AB1_504A19CC2BF9__INCLUDED_
...
#pragma once
#endif // _MSC_VER > 1000
#define PROTOCOL_SUNIN_WAIT			20
#define PROTOCOL_SUNIN_LENGTH		512
...
class SuninController  
{
public:
	SuninController();
	virtual ~SuninController();

	// Module Set/Get
	void SetOnOff(LIGHT_SUNIN_STATUS stLightInfo);
	void GetOnOffAll();
	
	// Brightness Set/Get
	void SetBrightness(LIGHT_SUNIN_STATUS stLightInfo);
	...
	// 프로토콜 구조체 생성
	LIGHT_SUNIN_STATUS m_stLightStatus;
