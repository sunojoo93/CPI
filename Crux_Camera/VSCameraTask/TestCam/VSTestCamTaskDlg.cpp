...
void CVSCameraTaskDlg::OnCbnSelchangeComboCam()
{
	...
	case IDC_COMBO_CAM_TRIMODE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("t", m_comboCamTriMode.GetCurSel());
		break;
	case IDC_COMBO_CAM_VDOUT:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("v", m_comboCamVdOut.GetCurSel());
		break;
	case IDC_COMBO_CAM_TAP:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("tap", m_comboCamTap.GetCurSel() + 1);
		break;
	case IDC_COMBO_CAM_TEST:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("T", m_comboCamTest.GetCurSel());
		break;
	}
}
...
void CVSCameraTaskDlg::OnBnClickedCheckCamReverse()
{
	...
	case IDC_CHECK_CAM_REVERSE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("rev", m_checkReverse.GetCheck());
		break;
	}
}
...
void CVSCameraTaskDlg::OnBnClickedButtonCam()
{
	...
	TrgCnt = GetPrivateProfileInt(_T("Settings"), _T("LineCount"), 20, IniPath);
	switch (buttonID)
	{
	case IDC_BUTTON_CAM_LOAD:
		((CTestCam*)theApp.m_pCamera)->m_Camera->LoadAllProperty();
		break;
	...
	case IDC_BUTTON_CAM_GRABSTART:
		((CTestCam*)theApp.m_pCamera)->StartGrab(VirID, VirID, _T("Test"), TrgCnt,false, true, true);
		break;
	case IDC_BUTTON_CAM_GRABSTOP:
		((CTestCam*)theApp.m_pCamera)->StopGrab(TrgCnt);
		break;
	}
}
...
void CVSCameraTaskDlg::OnEnChangeEditCam()
{
	...
	case IDC_EDIT_CAM_GR:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("r", value);
		break;
	case IDC_EDIT_CAM_GRFO:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("grfo", value);
		break;
	case IDC_EDIT_CAM_GRFE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("grfe", value);
		break;
	case IDC_EDIT_CAM_GRRO:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("grro", value);
		break;
	case IDC_EDIT_CAM_GRRE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("grre", value);
		break;
	case IDC_EDIT_CAM_GG:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("g", value);
		break;
	case IDC_EDIT_CAM_GGFO:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("ggfo", value);
		break;
	case IDC_EDIT_CAM_GGFE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("ggfe", value);
		break;
	case IDC_EDIT_CAM_GGRO:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("ggro", value);
		break;
	case IDC_EDIT_CAM_GGRE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("ggre", value);
		break;
	case IDC_EDIT_CAM_GB:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("b", value);
		break;
	case IDC_EDIT_CAM_GBFO:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("gbfo", value);
		break;
	case IDC_EDIT_CAM_GBFE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("gbfe", value);
		break;
	case IDC_EDIT_CAM_GBRO:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("gbro", value);
		break;
	case IDC_EDIT_CAM_GBRE:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("gbre", value);
		break;
	case IDC_EDIT_CAM_WBR:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("WBr", value);
		break;
	case IDC_EDIT_CAM_WBG:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("WBg", value);
		break;
	case IDC_EDIT_CAM_WBB:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("WBb", value);
		break;
	case IDC_EDIT_CAM_EXP:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("i", value);
		break;
	case IDC_EDIT_CAM_LINEDELAY:
		((CTestCam*)theApp.m_pCamera)->m_Camera->SetProperty("d", value);
		break;
	}
}
...
void CVSCameraTaskDlg::OnBnClickedButtonTrigger()
{
	...
	case IDC_BUTTON_TRIGGER_INIT_F:
		((CTestCam*)theApp.m_pCamera)->m_Trigger->StopTriggerGen0();
		((CTestCam*)theApp.m_pCamera)->m_Trigger->TriggerOrigin0();
		break;
	...
	case IDC_BUTTON_TRIGGER_SET_F:
		((CTestCam*)theApp.m_pCamera)->m_Trigger->TriggerStartPositionChannel0(
			((CTestCam*)theApp.m_pCamera)->TriggerStartF, ((CTestCam*)theApp.m_pCamera)->TriggerStopF, ((CTestCam*)theApp.m_pCamera)->TriggerPeriodF);
		break;
	case IDC_BUTTON_TRIGGER_SET_B:
		((CTestCam*)theApp.m_pCamera)->m_Trigger->TriggerStartPositionChannel0(
			((CTestCam*)theApp.m_pCamera)->TriggerStartB, ((CTestCam*)theApp.m_pCamera)->TriggerStopB, ((CTestCam*)theApp.m_pCamera)->TriggerPeriodB);
		break;
	case IDC_BUTTON_TRIGGER_SCAN_F:
		((CTestCam*)theApp.m_pCamera)->m_Trigger->StartForwardScan();
		break;
	case IDC_BUTTON_TRIGGER_SCAN_B:
		((CTestCam*)theApp.m_pCamera)->m_Trigger->StartBackwardScan();
		break;
	case IDC_BUTTON_TRIGGER_SAVE:
		lib->SetDataToINI(_T("Trigger"), _T("StartF"), ((CTestCam*)theApp.m_pCamera)->TriggerStartF, lib->GetData(_T("inifile")));
		lib->SetDataToINI(_T("Trigger"), _T("StartB"), ((CTestCam*)theApp.m_pCamera)->TriggerStartB, lib->GetData(_T("inifile")));
		lib->SetDataToINI(_T("Trigger"), _T("StopF"), ((CTestCam*)theApp.m_pCamera)->TriggerStopF, lib->GetData(_T("inifile")));
		lib->SetDataToINI(_T("Trigger"), _T("StopB"), ((CTestCam*)theApp.m_pCamera)->TriggerStopB, lib->GetData(_T("inifile")));
		lib->SetDataToINI(_T("Trigger"), _T("PeriodF"), ((CTestCam*)theApp.m_pCamera)->TriggerPeriodF, lib->GetData(_T("inifile")));
		lib->SetDataToINI(_T("Trigger"), _T("PeriodB"), ((CTestCam*)theApp.m_pCamera)->TriggerPeriodB, lib->GetData(_T("inifile")));
		lib->SetDataToINI(_T("Trigger"), _T("CountF"), ((CTestCam*)theApp.m_pCamera)->TriggerCountF, lib->GetData(_T("inifile")));
		lib->SetDataToINI(_T("Trigger"), _T("CountB"), ((CTestCam*)theApp.m_pCamera)->TriggerCountB, lib->GetData(_T("inifile")));
		break;
	}
}
...
{
	int heightPixel = ((CTestCam*)theApp.m_pCamera)->m_lDigSizeY;
	if (heightPixel < 0 || heightPixel > 999999)
		heightPixel = 1000;
	((CTestCam*)theApp.m_pCamera)->TriggerStartF = GetDlgItemInt(IDC_EDIT_TRIGGER_STARTPOS_F);
	((CTestCam*)theApp.m_pCamera)->TriggerStartB = GetDlgItemInt(IDC_EDIT_TRIGGER_STARTPOS_B);
	((CTestCam*)theApp.m_pCamera)->TriggerPeriodF = GetDlgItemInt(IDC_EDIT_TRIGGER_PERIOD_F);
	((CTestCam*)theApp.m_pCamera)->TriggerPeriodB = GetDlgItemInt(IDC_EDIT_TRIGGER_PERIOD_B);
	((CTestCam*)theApp.m_pCamera)->TriggerCountF = GetDlgItemInt(IDC_EDIT_TRIGGER_COUNT_F);
	((CTestCam*)theApp.m_pCamera)->TriggerCountB = GetDlgItemInt(IDC_EDIT_TRIGGER_COUNT_B);
	((CTestCam*)theApp.m_pCamera)->TriggerStopF =
		((CTestCam*)theApp.m_pCamera)->TriggerStartF + ((CTestCam*)theApp.m_pCamera)->TriggerPeriodF * ((CTestCam*)theApp.m_pCamera)->TriggerCountF * heightPixel;
	((CTestCam*)theApp.m_pCamera)->TriggerStopB =
		((CTestCam*)theApp.m_pCamera)->TriggerStartB + ((CTestCam*)theApp.m_pCamera)->TriggerPeriodB * ((CTestCam*)theApp.m_pCamera)->TriggerCountB * heightPixel;
	SetDlgItemInt(IDC_EDIT_TRIGGER_STOPPOS_F, ((CTestCam*)theApp.m_pCamera)->TriggerStopF);
	SetDlgItemInt(IDC_EDIT_TRIGGER_STOPPOS_B, ((CTestCam*)theApp.m_pCamera)->TriggerStopB);

	if (((CTestCam*)theApp.m_pCamera)->TriggerCountF > BUFFER_COUNT)
		SetDlgItemInt(IDC_EDIT_TRIGGER_COUNT_F, BUFFER_COUNT);
	if (((CTestCam*)theApp.m_pCamera)->TriggerCountB > BUFFER_COUNT)
