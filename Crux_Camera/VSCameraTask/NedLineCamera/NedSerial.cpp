...
bool CNedSerial::comSerialWrite(BYTE *pBuff, UINT32& Buffersize)
{
...
bool CNedSerial::comSerialRead(BYTE *pBuff, UINT32& Buffersize)
{
	unsigned long length;
...
int CNedSerial::SetCommand(char* Command,UINT32 TimeOut)
{
...
int CNedSerial::OpenComPort(UINT32 BaudRate, CString Portname)
{
	if (m_hComm != NULL)
		CloseComPort();
