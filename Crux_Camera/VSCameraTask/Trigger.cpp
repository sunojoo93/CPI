...
void	CTrigger::StopTriggerGen0()	 //트리거 신호 발생정지			 
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void	CTrigger::StopTriggerGen1()	 //트리거 신호 발생정지		 
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void	CTrigger::StartForwardScan()  // 순방향 스켄
{
	//2016.11.08 add by mby 
	//Message PanelID,EventID,EventInfo
	CString traceMsg;
...
void	CTrigger::StartBackwardScan()  // 역방향 스켄
{
	//2016.11.08 add by mby 
	//Message PanelID,EventID,EventInfo
	CString traceMsg;
...
void    CTrigger::TriggerInit0()  // 트리거 0 초기화
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerInit1()  // 트리거 1 초기화
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerOrigin()  // 원점 설정
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerStartPosition8K()  // 0번 발생주기, (AOI, 트리거번호, 시작위치, 끝위치, 주기)
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerStartPosition2K()  // 1번 발생주기, (AOI, 트리거번호, 시작위치, 끝위치, 주기)
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerCurrentPosition()  // 현재 위치값 읽기
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerGenCount0()  // 트리거 0 발생 카운터 갯수 읽기
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerGenCount1()  // 트리거 1 발생 카운터 갯수 읽기
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerStartPositionGet_00()  // 0번 발생주기, (AOI, 트리거번호, 시작위치, 끝위치, 주기)
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
void    CTrigger::TriggerStartPositionGet_01()  // 1번 발생주기, (AOI, 트리거번호, 시작위치, 끝위치, 주기) 
{
	if (pSys->m_Config.m_nTriggerBoardType == BOARD_TYPE_YOUNGWOO)
	{
...
BOOL CTrigger::StartTrigger(bool bState)
{
	...
	if(bState)
	{
		...
		if(	!m_bFirst									&& 
			...
			pSys->m_Config.m_nEqpType != EQP_TYPE_BIG	&&		// ABI 인 경우
			pSys->m_Config.m_nEqpType != EQP_TYPE_BIG_D9)		// 대형이 아닌 경우 패스.
		{
			StartForwardScan();
			return TRUE;
		}
