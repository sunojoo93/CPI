// GxStaticEx.h  : Microsoft Visual C++로 만든 ActiveX 컨트롤 래퍼 클래스의 선언입니다.
...
public:
	...
	void SetShade(short ShadeGranularity, short ShadeColoring, unsigned long ShadeHighColor, unsigned long ShadeMiddleColor, unsigned long ShadeLowColor)
	{
		...
		InvokeHelper(0x43, DISPATCH_METHOD, VT_EMPTY, NULL, parms, ShadeGranularity, ShadeColoring, ShadeHighColor, ShadeMiddleColor, ShadeLowColor);
	}
	void SetFontName(LPCTSTR sName)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x44, DISPATCH_METHOD, VT_EMPTY, NULL, parms, sName);
	}
	void SetFontSize(short nSize)
	{
		static BYTE parms[] = VTS_I2 ;
		InvokeHelper(0x45, DISPATCH_METHOD, VT_EMPTY, NULL, parms, nSize);
	}
	void SetFontBold(long bValue)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x46, DISPATCH_METHOD, VT_EMPTY, NULL, parms, bValue);
	}
	void SetFontItalic(long nValue)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x47, DISPATCH_METHOD, VT_EMPTY, NULL, parms, nValue);
	}
	...
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x63, DISPATCH_METHOD, VT_EMPTY, NULL, parms, bNewValue);
	}
