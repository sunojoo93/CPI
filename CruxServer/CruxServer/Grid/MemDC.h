...
class CMemDC_User : public CDC
{
public:

    // constructor sets up the memory DC
    CMemDC_User(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CMemDC_User* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CMemDC_User*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CMemDC_User
