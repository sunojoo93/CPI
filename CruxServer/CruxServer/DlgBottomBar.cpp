...
void CDlgBottomBar::Init(void)
{
	...
	m_btnAuto.SetCaption(_T("Auto"));
	m_btnAuto.SetFontSize(20);
	m_btnManual.SetCaption(_T("Manual"));
	//m_btnManual.SetEnabled(FALSE);
	m_btnManual.SetFontSize(20);
	m_btnReport.SetCaption(_T("Report"));
	m_btnReport.SetFontSize(20);
	m_btnSetup.SetCaption(_T("Setup"));
	m_btnSetup.SetFontSize(20);
	m_btnIOView.SetCaption(_T("I/O View"));
